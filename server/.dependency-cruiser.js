...
module.exports = {
  forbidden: [
    /* rules for enforcing hexagonal architecture */
    {
      name: "no-external-deps-within-core-domain",
      severity: "error",
      from: {
        path: "src/domain",
        pathNot: "src/domain/generated", // exception because generated domain model is based on graphql
      },
      to: {},
    },
    {
...
// generated: dependency-cruiser@11.2.1 on 2022-01-09T20:52:12.509Z
